...
from mPlate import cPlate

class cHelmetAndPlate :
    ...
    def __init__( self ) :
        ...
        self.vModelConf = r"C:\Users\DELL\Documents\work\major\conda37\project_prepare\active\helmet_detection\resourse\yolov3-Helmet-Detection\yolov3-obj.cfg"

        self.vModelWeights = r"C:\Users\DELL\Documents\work\major\conda37\project_prepare\active\helmet_detection\resourse\yolov3-Helmet-Detection\yolov3-obj_2400.weights"
    ...
    def fPostProcess( self, fvFrame, fvNetOut ) :
        ...
        if vIndiceLen == 0 :
            ...
            #vLicensePNum = cPlate.fDetectLPlate( fvFrame ) ##<-- 

        else :

            print( '[ DEBUG ] {} helmet(s) found.'.format( vIndiceLen ) )
