         ...
         $sql="select * from rulebreak";
          ...
          foreach ($result as $row)
          {
              $r=$row['breakid'];
                  ...
                  ?>
            <tr>
                <td><?php echo $row['breakid']?></td>
                <td><?php echo $row['vehicleno']?></td>
                <td><?php echo $row['type']?></td>
               <?php   $id=$row['vehicleno']?>
                <td class="text-center"><a class='btn btn-info btn-xs'  href="vehicleDetails.php?no=<?php echo $id;?>"><span class="glyphicon glyphicon-edit"></span>View Details</a> </td>
